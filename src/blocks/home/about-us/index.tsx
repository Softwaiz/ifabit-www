...
export function AboutUs() {
  return (
    <div className="w-full flex flex-col items-center justify-center bg-slate-200 text-slate-900 about">
      <div className="container p-[4rem] min-h-screen flex flex-col items-center justify-center  gap-8">
        <div className="w-full flex flex-col items-center justify-center">
          <h2 className="font-heading font-bold text-4xl">Avec ifabit,</h2>
        </div>
